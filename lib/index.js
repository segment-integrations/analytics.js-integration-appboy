...
Appboy.prototype.initializeV1 = function(customEndpoint) {
  var options = this.options;
  var self = this;
  var userId = this.analytics.user();
  // guard against user() not returning a user object
  if (userId != null) {
    userId = userId.id();
  }
...
Appboy.prototype.initializeV2 = function(customEndpoint) {
  ...
  this.supportsMessagingReadyCallback = true;
...
Appboy.prototype.identify = function(identify) {
  ...
  window.appboy.changeUser(userId, window.__hack_segment_appboy_change_user_sb);
...
Appboy.prototype.track = function(track) {
  ...
  if (this.supportsMessagingReadyCallback) {
    if (userId) {
      window.appboy.changeUser(userId, function() {
